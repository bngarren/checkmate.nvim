...
---This picker can be customized via the `ui.picker` option in the config.
---
---**Custom Picker:**
---Pass a `picker_fn` to use your own picker implementation. Your function will receive:
...
---
---Example with custom picker function:
---
---```lua
